...
type
  TfmPassword = class(TForm)
    ...
    procedure Edit1KeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
      Shift: TShiftState);
    procedure txtForgotClick(Sender: TObject);
  private
...
procedure TfmPassword.btnCancelClick(Sender: TObject);
begin
...
procedure TfmPassword.Edit1KeyUp(Sender: TObject; var Key: Word;
...
procedure TfmPassword.Edit1Typing(Sender: TObject);
begin
textError.Text:='';
end;

procedure TfmPassword.Edit2KeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
if KeyChar = #13 then
 btnOkClick (self);
...
procedure TfmPassword.txtForgotClick(Sender: TObject);
begin
modalResult:= mrContinue;
end;

function TfmPassword.verifyKeyExist: boolean;
begin
 with TRegistry.Create do
 begin
  Result:= false;
...
function TfmPassword.ValidateKey(key: string): boolean;
var
